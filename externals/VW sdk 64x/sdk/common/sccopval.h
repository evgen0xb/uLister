...
#define SCCUT_FILTER_OPTIMIZEDFORTEXTANNO               2
#define SCCUT_FILTER_IMAGEFILEFORMAT			BIT17
#define SCCUT_CANUSEIMAGEEXPORT			        BIT18
#define SCCUT_FILTER_VWGRAPHICFORMAT                    BIT19
#define SCCUT_FILTER_HTMLFORMAT                         BIT20
#define SCCUT_FILTER_PDFFILEFORMAT                      BIT21
...
#define  SCCEX_XML_SEARCHML_DOTUNDERLINE			0x20000000
#define  SCCEX_XML_SEARCHML_WORDUNDERLINE		0x40000000
#define  SCCEX_XML_SEARCHML_ANYHIDDEN    (SCCEX_XML_SEARCHML_HIDDEN | SCCEX_XML_SEARCHML_REVISIONDELETE)
#define  SCCEX_XML_SEARCHML_ANYUNDERLINE (SCCEX_XML_SEARCHML_UNDERLINE | SCCEX_XML_SEARCHML_DUNDERLINE | SCCEX_XML_SEARCHML_DOTUNDERLINE | SCCEX_XML_SEARCHML_WORDUNDERLINE )
#define  SCCEX_XML_SEARCHML_ALLCHARATTRS (SCCEX_XML_SEARCHML_BOLD | SCCEX_XML_SEARCHML_ITALIC | SCCEX_XML_SEARCHML_UNDERLINE | SCCEX_XML_SEARCHML_DUNDERLINE | SCCEX_XML_SEARCHML_OUTLINE | SCCEX_XML_SEARCHML_HIDDEN | SCCEX_XML_SEARCHML_STRIKEOUT | SCCEX_XML_SEARCHML_SMALLCAPS | SCCEX_XML_SEARCHML_ALLCAPS | SCCEX_XML_SEARCHML_OCE | SCCEX_XML_SEARCHML_REVISIONDELETE | SCCEX_XML_SEARCHML_REVISIONADD | SCCEX_XML_SEARCHML_DOTUNDERLINE | SCCEX_XML_SEARCHML_WORDUNDERLINE)
...
/* Added to set the BIDI flag in PDF filter*/
#define SCCFILTER_PDF_BIDI_LIFEBIT_MASK	BIT30
...
/* Values for SCCOPT_TRACK_ANNOTATIONS */
#define SCCOPT_TRACK_REDACTIONS   0x0001
#define SCCOPT_TRACK_HIGHLIGHTS   0x0002
#define SCCOPT_TRACK_ALL          (SCCOPT_TRACK_REDACTIONS|SCCOPT_TRACK_HIGHLIGHTS)
