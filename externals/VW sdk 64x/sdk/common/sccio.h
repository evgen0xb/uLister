...
{
    BASEIO                          sBaseIO; /* Optional access to the original input file */
...
*/
/* mm/dd/yy 03/07/19 niyayada  bug-27524189  */
#define IO_COMPRESSBUFFERSIZE       0x00040100
...
#endif
    VTDWORD         	    dwFileSizeForIdx; //pijjain
} IO7ZNODE, * PIO7ZNODE;
...
typedef struct JBIG2_CSD_tag
{
	JBIG2_SymbolDictionary sd;
	VTLONG lRefCount;
}JBIG2_CSD, *PJBIG2_CSD;

typedef struct JBIG2_SymbolSettings_tag
{
    VTBOOL					bHuff;
	VTBOOL					bRefAgg;
	PJBIG2_CSD	pSDInSyms;			/*Symbol distionary that is used as an input to this symbol dictionary. It contains dwNumInSyms symbols */
...
typedef struct JBIG2_TextSettings_tag
{
	...
	PJBIG2_CSD pSBSyms; /*An Array containing the symols used in this text region. COntains SBNUMSYMS symbols */
...
typedef struct JBIG2_RefinementSettings_tag
{
	...
	VTLONG		lRDX;
	VTLONG		lRDY;
#if defined(__powerpc__) || defined(__s390__) /*Bug-33453469 | 21-Jan-21 | pijjain*/
        signed char     GRAT[4];
#else
        VTCHAR          GRAT[4];
#endif
