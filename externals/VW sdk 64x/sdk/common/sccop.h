...
#define SCCOPT_GRAPHIC_SCALEHEIGHT							140
#define SCCOPT_GRAPHIC_SCALEWIDTH							141
...
/* PDF new colorspacing algorithm */
#define SCCOPT_PDF_FILTER_NEW_COLORSPACING_ALGORITHM             SCCID_PDF_FILTER_NEW_COLORSPACING_ALGORITHM
...
/* Enable JPXDECODE support for pdf*/
#define SCCOPT_PDF_FILTER_ENABLE_JPXDECODE                  SCCID_PDF_FILTER_ENABLE_JPXDECODE
...
/* Excel option to disable Print Area */
#define SCCOPT_DISABLE_PRINT_AREA                           SCCID_DISABLEPRINTAREA

/* PDF option to enable image scale DPI */
#define SCCOPT_GRAPHIC_SCALEDDPI                            SCCID_GRAPHIC_SCALEDDPI

/*PDF Print option to enable bitmap printing*/
#define SCCOPT_ENABLE_PDF_BITMAP_PRINTING                    SCCID_ENABLE_PDF_BITMAP_PRINTING
...
typedef struct UTPDFOPTIONStag
{
    ...
    VTBOOL      bNewPDFSpacing;
    VTBOOL      bNewPDFColorSpacing;
    VTBOOL      bGraphicScaledDPI; 
    VTBOOL      bJPXdecodeSupport;
...
typedef struct UTH5XOPTIONStag
{
	...
	VTBOOL                    bEnableVectorObjectLimitPopup;
...
typedef struct UTOPTIONStag
{
    ...
    VTBOOL             bFlagBackgroundColor;   /*This flag is used to explicitly set the background color of the Document to White*/
    VTBOOL             bExcelDisablePrintArea; /* enable/disable Print-Area in Excel documents*/
	
    VTBOOL             bPdfBitmapPrinting; /*Enable Bitmap printing for PDF documents*/
