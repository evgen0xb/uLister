...
#define  SCCCA_DOTUNDERLINE			0x20000000
#define  SCCCA_WORDUNDERLINE		0x40000000
#define  SCCCA_ANYHIDDEN    (SCCCA_HIDDEN | SCCCA_REVISIONDELETE)
#define  SCCCA_ANYUNDERLINE (SCCCA_UNDERLINE | SCCCA_DUNDERLINE | SCCCA_DOTUNDERLINE | SCCCA_WORDUNDERLINE )
#define  SCCCA_ALLCHARATTRS (SCCCA_BOLD | SCCCA_ITALIC | SCCCA_UNDERLINE | SCCCA_DUNDERLINE | SCCCA_OUTLINE | SCCCA_HIDDEN | SCCCA_STRIKEOUT | SCCCA_SMALLCAPS | SCCCA_ALLCAPS | SCCCA_OCEMASK | SCCCA_REVISIONDELETE | SCCCA_REVISIONADD | SCCCA_DOTUNDERLINE | SCCCA_WORDUNDERLINE)
...
#define SCCCA_STATUS_VERSION3 EXSTATUSVERSION3
