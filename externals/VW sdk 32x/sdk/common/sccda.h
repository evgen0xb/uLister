...
#define DAERR_CHUNKERDATAOVERFLOW     SCCERR_CHUNKERDATAOVERFLOW
...
#define DAOBJECTFLAG_EMBEDDING         0x00000080 /* Object is an embedding                                      */
...
typedef struct EXSTATUSINFORMATIONtag
{
	...
	VTBOOL bIncorrectPageSize;      /* a PDF file was larger than 200 in x 200 in, as specified in the PDF reference guide */ // RNT for 27301827, 30/Jan/2018
	VTBOOL bIncorrectPageSize_lower;/* a PDF file was smaller than 3 units x 3 units, as specified in the PDF reference guide */ // RNT, bug 24675020, 25-APR-2018
    ...
    unsigned int currPathSize, maxPathLimit;            //RNT, bug 28044429, 30/APR/2019
    unsigned int currVectSize, maxVectLimit;            //RNT, bug 28044429, 30/APR/2019
    unsigned int currObjtSize, maxObjtLimit;            //RNT, bug 28044429, 30/APR/2019
    VTBOOL bFontWidthUsed;          /* a PDF file is using Width parameter to change widths of glyphs */ // RNT, bug 31754216, 30/JAN/2021
} EXSTATUSINFORMATION;

#define EXSTATUSVERSION1 	0X0001
#define EXSTATUSVERSION2 	0X0002
#define EXSTATUSVERSION3 	0X0003

#define EXSTATUSVERSION_LATEST  EXSTATUSVERSION3    /*used in dwVersion in EXSTATUSINFORMATION*/
...
DA_ENTRYSC DAERR DA_ENTRYMOD DAGetStatusInfo(VTHDOC	hItem, VTLPVOID pstatus);
