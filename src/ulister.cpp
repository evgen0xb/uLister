...
// нужно помнить строку поиска дл€ каждого окна uLister, чтобы правильно выводить сообщение, что именно Ќ≈ найдено,
// т.к. в каждом окне строка поиска FORWARD/BACK независима€.
